...
import org.apache.ambari.server.ecwid.consul.v1.acl.AclClient;
import org.apache.ambari.server.ecwid.consul.v1.acl.AclConsulClient;
...
import org.apache.ambari.server.ecwid.consul.v1.agent.AgentClient;
import org.apache.ambari.server.ecwid.consul.v1.agent.AgentConsulClient;
...
import org.apache.ambari.server.ecwid.consul.v1.catalog.CatalogClient;
import org.apache.ambari.server.ecwid.consul.v1.catalog.CatalogConsulClient;
...
import org.apache.ambari.server.ecwid.consul.v1.catalog.model.CatalogService;
import org.apache.ambari.server.ecwid.consul.v1.catalog.model.Node;
import org.apache.ambari.server.ecwid.consul.v1.coordinate.CoordinateClient;
import org.apache.ambari.server.ecwid.consul.v1.coordinate.CoordinateConsulClient;
import org.apache.ambari.server.ecwid.consul.v1.coordinate.model.Datacenter;
import org.apache.ambari.server.ecwid.consul.v1.event.EventClient;
import org.apache.ambari.server.ecwid.consul.v1.event.EventConsulClient;
...
import org.apache.ambari.server.ecwid.consul.v1.health.HealthClient;
import org.apache.ambari.server.ecwid.consul.v1.health.HealthConsulClient;
import org.apache.ambari.server.ecwid.consul.v1.health.model.HealthService;
import org.apache.ambari.server.ecwid.consul.v1.kv.KeyValueClient;
import org.apache.ambari.server.ecwid.consul.v1.kv.KeyValueConsulClient;
...
import org.apache.ambari.server.ecwid.consul.v1.session.SessionClient;
import org.apache.ambari.server.ecwid.consul.v1.session.SessionConsulClient;
...
import org.apache.ambari.server.ecwid.consul.v1.status.StatusClient;
import org.apache.ambari.server.ecwid.consul.v1.status.StatusConsulClient;
...
public class ConsulClient implements
	...
	@Override
	public Response<List<org.apache.ambari.server.ecwid.consul.v1.coordinate.model.Node>> getNodes(QueryParams queryParams) {
	...
	@Override
	public Response<List<org.apache.ambari.server.ecwid.consul.v1.health.model.Check>> getHealthChecksForNode(String nodeName, QueryParams queryParams) {
		return healthClient.getHealthChecksForNode(nodeName, queryParams);
	}

	@Override
	public Response<List<org.apache.ambari.server.ecwid.consul.v1.health.model.Check>> getHealthChecksForService(String serviceName, QueryParams queryParams) {
	...
	@Override
	public Response<List<org.apache.ambari.server.ecwid.consul.v1.health.model.Check>> getHealthChecksState(QueryParams queryParams) {
		return healthClient.getHealthChecksState(queryParams);
	}

	@Override
	public Response<List<org.apache.ambari.server.ecwid.consul.v1.health.model.Check>> getHealthChecksState(org.apache.ambari.server.ecwid.consul.v1.health.model.Check.CheckStatus checkStatus, QueryParams queryParams) {
